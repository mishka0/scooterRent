...
START TRANSACTION;
USE `rent`;
INSERT INTO `rent`.`history` (`history_id`, `scooter_id`, `user_id`, `tariff_id`, `date_of_ride`, `final_cost`, `is_subscription`, `time_start`, `time_end`, `is_closed`) VALUES (DEFAULT, 1, 3, NULL, '2020:06:19', 45, 0, '13:00:00', '14:00:00', 1);
INSERT INTO `rent`.`history` (`history_id`, `scooter_id`, `user_id`, `tariff_id`, `date_of_ride`, `final_cost`, `is_subscription`, `time_start`, `time_end`, `is_closed`) VALUES (DEFAULT, 2, 5, NULL, '2020:06:19', 44, 0, '12:00:00', '12:45:00', 1);
INSERT INTO `rent`.`history` (`history_id`, `scooter_id`, `user_id`, `tariff_id`, `date_of_ride`, `final_cost`, `is_subscription`, `time_start`, `time_end`, `is_closed`) VALUES (DEFAULT, 3, 4, NULL, '2020:06:19', 0, 1, '15:00:00', '15:10:00', 1);
