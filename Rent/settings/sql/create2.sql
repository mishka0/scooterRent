...
CREATE TABLE IF NOT EXISTS `rent`.`history` (
  ...
  INDEX `fk_history_scooter1_idx` (`scooter_id` ASC) ,
  INDEX `fk_history_user1_idx` (`user_id` ASC) ,
  INDEX `fk_history_tariff_idx` (`tariff_id` ASC) ,
  INDEX `fk_history_subscription_idx` (`subscription_id` ASC) ,
  ...
  CONSTRAINT `fk_history_scooter1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_history_tariff`
    FOREIGN KEY (`tariff_id`)
    REFERENCES `rent`.`tariff` (`tariff_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_history_subscription`
    FOREIGN KEY (`subscription_id`)
    REFERENCES `rent`.`subscription` (`subscription_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `rent`.`rental_point` (
  ...
  INDEX `fk_rental_point_town1_idx` (`town_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `rent`.`scooter` (
  ...
  INDEX `status_fk_idx` (`status_id` ASC) ,
  INDEX `fk_scooter_rental_point1_idx` (`rental_point_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `rent`.`subscription` (
  ...
  INDEX `fk_subscription_info1_idx` (`subs_info_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `rent`.`user_role` (
  ...
  `user_id` INT NOT NULL,
  INDEX `fk_users_roles_user_idx` (`user_id` ASC) ,
...
START TRANSACTION;
USE `rent`;
INSERT INTO `rent`.`history` (`history_id`, `scooter_id`, `user_id`, `tariff_id`, `subscription_id`, `date_of_ride`, `final_cost`, `time_start`, `time_end`, `is_closed`) VALUES (DEFAULT, 1, 3, NULL, NULL, '2020:06:19', 45, '13:00:00', '14:00:00', 1);
INSERT INTO `rent`.`history` (`history_id`, `scooter_id`, `user_id`, `tariff_id`, `subscription_id`, `date_of_ride`, `final_cost`, `time_start`, `time_end`, `is_closed`) VALUES (DEFAULT, 2, 5, NULL, NULL, '2020:06:19', 44, '12:00:00', '12:45:00', 1);
INSERT INTO `rent`.`history` (`history_id`, `scooter_id`, `user_id`, `tariff_id`, `subscription_id`, `date_of_ride`, `final_cost`, `time_start`, `time_end`, `is_closed`) VALUES (DEFAULT, 3, 4, NULL, 1, '2020:06:19', 0, '15:00:00', '15:10:00', 1);
